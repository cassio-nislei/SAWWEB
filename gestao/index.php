...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: <?php echo isset($_SESSION["parametros"]["color"]) ? $_SESSION["parametros"]["color"] : '#224abe'; ?> !important;">
