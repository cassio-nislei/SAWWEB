...
if (typeof jQuery !== "undefined" && jQuery.fn) {
  // Definir a função
  var tabsFunction = function (options) {
    ...
    $this.each(function () {
      ...
      $tabs.on("click", function () {
        ...
        $el.trigger("tabsactivate", [{ tab: $tab, panel: $panels.eq(index) }]);
      });
    });
  ...
  console.log(
    "✅ jQuery UI Tabs (minimal fallback) carregado. typeof $.fn.tabs =",
    typeof $.fn.tabs,
  );
}
